...
class SmoothedValue(object):
    ...
    def update(self, value, n=1):
        ...
        self.count += n
        self.total += value * n #correct number
...
def save_model(args, epoch, model, model_ema=None):
    # epoch_name = str(epoch)
    # client_state = {'epoch': epoch}
    # if model_ema is not None:
    #     client_state['model_ema'] = get_state_dict(model_ema)
    # model.save_checkpoint(save_dir=args.output_dir+'/model.pth',  client_state=client_state)
